...
namespace jl
{
	...
	public:
		...
		Connection(net::socket&& socket, std::size_t buffer_max_size = kDefaultBufferMaxSize);
	...
	public:
		SSLConnection(net::socket&& socket, std::size_t buffer_max_size = kDefaultBufferMaxSize);
